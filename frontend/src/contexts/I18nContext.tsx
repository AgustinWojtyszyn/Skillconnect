...
const translations: Record<Lang, Record<string, string>> = {
  ...
  'people.requests.tab': 'Solicitudes',
  'people.requests.incoming': 'Solicitudes recibidas',
  'people.requests.noIncoming': 'No tienes solicitudes entrantes',
  'people.requests.outgoing': 'Solicitudes enviadas',
  'people.requests.noOutgoing': 'No tienes solicitudes enviadas',
  ...
  'people.requests.tab': 'Requests',
  'people.requests.incoming': 'Incoming requests',
  'people.requests.noIncoming': 'You have no incoming requests',
  'people.requests.outgoing': 'Outgoing requests',
  'people.requests.noOutgoing': 'You have no outgoing requests',
